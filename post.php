    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
            ...
            $query_all_post = "SELECT * FROM posts WHERE post_id = $post_id";
            ...
            if (isset($_POST['post_comment'])){
                ...
                include_once ("includes/connection.php");
                $query_insert = "INSERT INTO comments (comment_post_id, comment_author, comment_email, comment_content, comment_date) VALUES ('$post_id','$comment_author', '$comment_email', '$comment_content', '$comment_date')";
                mysqli_query($connection, $query_insert);
                if(mysqli_errno($connection)){
                    die("Some error in inserting comment ".mysqli_error($connection));
                }
            }
            ?>
