...
//END OF ON PRESS OF EDIT SUBMIT BUTTON4

//CODE TO LOAD DATA OF POST WHEN THE PAGE IS LOADED FOR THE FIRST TIME
            ...
            <div class="col-md-12">
                <form action="" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        $i=0;
                        ?>
                        <select type="text" class="form-control" name="post_cat_id" id="post_cat_id" >
                            <?php
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo $post_tags;?>"name="post_tags" id="post_tags" >
                    </div>
                    ...
                    <button type="submit" class="btn btn-outline-warning" name="edit_post">Publish</button>
                </form>
            </div>
        </div>
        <div class="mb-4"></div>
